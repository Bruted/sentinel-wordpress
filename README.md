...
Sentinel is a CAPTCHA + IP-reputation service. This plugin is **free to install and completely inert until you enter your keys** — no widget, no requests, no behaviour change until it is configured.
...
6. Optionally set a custom **Base URL** to point at a custom Sentinel endpoint (default `https://redeyed.com`).
